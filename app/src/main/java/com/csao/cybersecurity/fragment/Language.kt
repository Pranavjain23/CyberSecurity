...
class Language : Fragment() {
    ...
    override fun onCreateView(
        ...
        btnTelugu=view.findViewById(R.id.btn5)
        ...
        btnTelugu.setOnClickListener {
            LocaleHelper.setLocale(context, "te")
            btnTelugu.setBackgroundColor(R.color.lightBlue)
            btnTelugu.setTextSize(30F)
